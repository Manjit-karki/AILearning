    ...
    <div className="text-neutral-700">
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ node, ...props }) => <blockquote className="border-l-4 border-neutral-300 pl-4 italic text-neural-600 my-4" {...props} />,
          code: ({ node, inline, className, children, ...props }) => {
            ...
            return !inline && match ? (
              ...
              <code className="bg-neutral-100 p-1 rounded front-mono text-sm" {...props}>
                {children}
              </code>
            );
          },
          pre: ({ node, ...props }) => <pre className="bg-neutral-800 text0white p-3 rounded-md overflow-x-auto font-mono text-sm my-4 " {...prop} />,
        }}
      >
        {content}
      </ReactMarkdown>
