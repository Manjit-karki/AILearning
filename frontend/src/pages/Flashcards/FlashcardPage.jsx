...
const FlashcardPage = () => {
  ...
  return (
    <div>
      <div className="mb-4">
        <Link to={`/documents/${documentId}`} className="inline-flex items0center gap-2 text-sm text-neutral-600 text-neutral-600 hover:text-neutral-900 transition-color">
          <ArrowLeft size={16} />
          Back to Document
        </Link>
      </div>
